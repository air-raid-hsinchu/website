...
const Page23 = () => {
  ...
  const getBackgroundImageDimensions = () => {
    ...
    if (mapRef.current) {
      setBgImgOffset({
        x: mapRef.current.offsetLeft,
        y: mapRef.current.offsetTop,
      });
    }
  };
        ...
        <Fade in={true} timeout={fadeInOptions.timeout}>
          <div className="background d-flex align-items-start">
            ...
            >
              ...
              <div
                className="d-flex align-items-center justify-content-center position-sticky"
                style={{
              ...
              >
                <MapPin
                  offset={{
                    x: bgImgOffset.x + bgImgSize.width * 0.284,
                    y: bgImgOffset.y + bgImgSize.height * 0.365,
                  }}
                  ...
                  data={{
                    ...
                    date: "1945年1月17日",
                    description:
                      "第二十航空隊選定新竹飛行場為轟炸目標，從上午10至11時，對新竹機場投下1,459枚500磅炸彈，459枚500磅燒夷彈。此次空襲造成新竹飛行場附近電話線、高壓電線和水管破裂。",
                  }}
                  infoPosition={{
                    x: bgImgOffset.x + bgImgSize.width * 0.065,
                    y: bgImgOffset.y + bgImgSize.height * 0.5,
                  }}
                  isHover={hover === 1}
                />
              </div>
              ...
              >
                <MapPin
                  offset={{
                    x: bgImgOffset.x + bgImgSize.width * 0.423,
                    y: bgImgOffset.y + bgImgSize.height * 0.673,
                  }}
                  ...
                  data={{
                    ...
                    date: "1945年3月17日",
                    description:
                      "第五航空隊第22大隊第2 、19、 33、 408轟炸中隊21架Ｂ-24以1,000磅炸彈轟炸新竹市區和鐵路設施，市內新興町、黑金町（今新竹市東區西大路和客雅溪之間，和今新竹車站東側）一帶的電信電話線和運輸電線因此被切斷，多處房屋燒毀。",
                  }}
                  infoPosition={{
                    x: bgImgOffset.x + bgImgSize.width * 0.18,
                    y: bgImgOffset.y + bgImgSize.height * 0.673,
                  }}
                  field={{
                    width: 108,
                    height: 100,
                    x: bgImgOffset.x + bgImgSize.width * 0.406,
                    y: bgImgOffset.y + bgImgSize.height * 0.62,
                    rot: "rotate(-35deg)",
                  }}
                  isHover={hover === 2}
                />
              ...
              >
                <MapPin
                  offset={{
                    x: bgImgOffset.x + bgImgSize.width * 0.525,
                    y: bgImgOffset.y + bgImgSize.height * 0.528,
                  }}
                  ...
                  data={{
                    ...
                    date: "1945年5月15日",
                    description:
                      "B24轟炸大隊於中午時刻飛往新竹市，聯合以250磅炸彈轟炸新竹市區。新竹市東區幾乎全燬，市區多處被炸燬破壞，大火持續延燒三日才止息，為最慘重之紀錄。位於市中心的新竹驛房屋頂遭炸毀，當天新竹紡織工場五棟全壞、大日本帝國製糖株式會社新竹製糖廠所的工場六棟全燒燬。",
                  }}
                  infoPosition={{
                    x: bgImgOffset.x + bgImgSize.width * 0.685,
                    y: bgImgOffset.y + bgImgSize.height * 0.45,
                  }}
                  isHover={hover === 3}
                />
              </div>
              ...
              >
                <MapPin
                  offset={{
                    x: bgImgOffset.x + bgImgSize.width * 0.497,
                    y: bgImgOffset.y + bgImgSize.height * 0.629,
                  }}
                  size={{ width: 150, height: 50 }}
              ...
              >
                <MapPin
                  offset={{
                    x: bgImgOffset.x + bgImgSize.width * 0.598,
                    y: bgImgOffset.y + bgImgSize.height * 0.629,
                  }}
              ...
              >
                <MapPin
                  offset={{
                    x: bgImgOffset.x + bgImgSize.width * 0.713,
                    y: bgImgOffset.y + bgImgSize.height * 0.618,
                  }}
                  size={{ width: 150, height: 50 }}
                  data={{
                    landmark: ["六燃大煙囪"],
                    ...
                    date: "1944年10月14日",
                    description:
                      "第六燃料廠新竹支廠有34名工廠員工被炸死，並且數座油槽傾倒。\n日本海軍第六燃料廠新竹支廠，為因應日本太平洋戰爭的軍事生產需求而生，用以製造航空燃料的加工劑異辛烷。為日軍重要軍事基地，因此多次遭到轟炸。",
                  }}
                  infoPosition={{
                    x: bgImgOffset.x + bgImgSize.width * 0.72,
                    y: bgImgOffset.y + bgImgSize.height * 0.56,
                  }}
                  isHover={hover === 4}
                />
              </div>
