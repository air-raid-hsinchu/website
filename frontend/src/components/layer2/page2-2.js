  ...
  return (
    <div className="layer2bg">
      ...
      <div
        ...
        // style={{ height: "100vh" }}
      >
        <div className="container-fluid d-flex justify-content-center" id="text">
          <div className="col-8 mx-auto">
            <div className="d-flex flex-column">
              ...
              <p>
                ...
                「疎開」是日語（そかい
                sokai）的漢字寫法，在中文裡「疏」和「疎」音譯相同，疏開指戰爭時期避免傷亡的疏散避難行動，如戰時的「學童疏開」指學校內學生往郊區躲避，「工廠疏開」指將工廠搬移至安全的地方，「建築疏開」指為了避免空襲延燒而開闢防空空地。「疎開」是日語（そかい
                sokai）的漢字寫法，在中文裡「疏」和「疎」音譯相同，疏開指戰爭時期避免傷亡的疏散避難行動，如戰時的「學童疏開」指學校內學生往郊區躲避，「工廠疏開」指將工廠搬移至安全的地方，「建築疏開」指為了避免空襲延燒而開闢防空空地。「疎開」是日語（そかい
                sokai）的漢字寫法，在中文裡「疏」和「疎」音譯相同，疏開指戰爭時期避免傷亡的疏散避難行動，如戰時的「學童疏開」指學校內學生往郊區躲避，「工廠疏開」指將工廠搬移至安全的地方，「建築疏開」指為了避免空襲延燒而開闢防空空地。「疎開」是日語（そかい
                sokai）的漢字寫法，在中文裡「疏」和「疎」音譯相同，疏開指戰爭時期避免傷亡的疏散避難行動，如戰時的「學童疏開」指學校內學生往郊區躲避，「工廠疏開」指將工廠搬移至安全的地方，「建築疏開」指為了避免空襲延燒而開闢防空空地。「疎開」是日語（そかい
                sokai）的漢字寫法，在中文裡「疏」和「疎」音譯相同，疏開指戰爭時期避免傷亡的疏散避難行動，如戰時的「學童疏開」指學校內學生往郊區躲避，「工廠疏開」指將工廠搬移至安全的地方，「建築疏開」指為了避免空襲延燒而開闢防空空地。「疎開」是日語（そかい
